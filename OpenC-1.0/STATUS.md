...
official OpenC source extension:      .p; 281 MIGRATED, 393 TOTAL `.p` SOURCES
...
self-hosted compiler:                 YES; SH-10 PASS, NATIVE PROJECT WORKFLOW
...
native validation budget:            PASS; 68.471 S <= 90 S, 278/278
native self-rebuild budget:          PASS; 744.926 S <= 900 S, BYTE-IDENTICAL
...
next engineering milestone:          SH-11 NATIVE LANGUAGE-SERVICE COMPLETENESS
...
implementation tests:               8/8 D COMMANDS; 21/21 PYTHON TESTS
...
contracts in the relocated standalone gate. SH-11 is next: the native
language-service protocol and editor-facing diagnostic/formatting lifecycle.
