...
official OpenC source extension:      .p; 281 MIGRATED, 391 TOTAL `.p` SOURCES
...
self-hosted compiler:                 YES; SH-9 PASS, PUBLIC NATIVE CLI
...
next engineering milestone:          SH-10 NATIVE PROJECT WORKFLOW COMPLETENESS
...
implementation tests:               8/8 D COMMANDS; 15/15 PYTHON TESTS
...
explanation, and direct CLI execution of all six demos. SH-10 is next:
native formatter, project inspection, and deterministic test workflows.
