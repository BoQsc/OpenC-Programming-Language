...
canonical OpenC compiler source:     104 `.p` UNITS; SELF-HOSTED
legacy D reference source:           OPTIONAL AUDIT; NOT AUTHORITY
legacy Python bootstrap source:      OPTIONAL AUDIT; NOT AUTHORITY
official OpenC source extension:      .p; 281 MIGRATED, 403 TOTAL `.p` SOURCES
...
self-hosted compiler:                 YES; SH-15 PASS, OPENC IMPLEMENTATION AUTHORITY
self-host performance regression:    PASS; 6.218 S MEDIAN, 7.156 S MAXIMUM
compiler throughput readiness:       PASS; 0.369x PINNED SAME-HOST D MEDIAN
D-reference comparison:              OPENC 6.218 S; D 16.862 S; FIVE RUNS EACH
...
native self-rebuild budget:          PASS; 6.218 S MEDIAN <= 30 S, BYTE-IDENTICAL
...
completed engineering milestone:     SH-15 WINDOWS X64 ABI + MACHINE CODE
next engineering milestone:          SH-16 PE32+ + CRT-FREE OPENC RUNTIME
...
active critical path:                 PE/RUNTIME -> WINMD -> NATIVE BACKEND -> TCC EXIT
...
external evidence tests:            8/8 D AUDITS; 35/35 PYTHON TESTS
...
version-one unwind records, and 25/25 executable/static probes while retaining
the throughput budgets. SH-16 CRT-free PE32+ runtime is active. It leads into
Win32 Metadata
