...
1. `OpenC_Core_Current.md`
2. `grammar/OpenC_Core_Grammar.ebnf`
3. `metadata/OpenC_Core_Rule_Index.json`
4. `metadata/OpenC_Core_Diagnostic_Catalog.json`
5. `metadata/OpenC_Core_Term_Index.json`
