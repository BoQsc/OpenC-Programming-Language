...
| 6. Incremental objects | Isolated interface, COFF identity, module objects, bounded saved-file relink passed; actual cache hits not implemented | [Interface projection](https://github.com/BoQsc/OpenC-Programming-Language/blob/c0b2343/SH27_INTERFACE_FINGERPRINT_EVIDENCE.md), [stable COFF names](https://github.com/BoQsc/OpenC-Programming-Language/blob/f68c65f/SH27_STABLE_COFF_IDENTITY_EVIDENCE.md), [module objects](https://github.com/BoQsc/OpenC-Programming-Language/blob/bd0a497/SH27_MODULE_COFF_SET_EVIDENCE.md), and [native relink](https://github.com/BoQsc/OpenC-Programming-Language/blob/1561b71/SH27_NATIVE_MODULE_COFF_LINK_EVIDENCE.md) passed focused proofs. [Saved-file relink](https://github.com/BoQsc/OpenC-Programming-Language/blob/3205432/SH27_SAVED_OBJECT_RELINK_EVIDENCE.md) reproduces the PE without a source manifest; the [pre-allocation reader guard](https://github.com/BoQsc/OpenC-Programming-Language/blob/8946b9b/SH27_PREALLOCATION_COFF_READER_EVIDENCE.md) rejects 128 MiB input under a 64 MiB process budget. Strict Stage 3→4 self-build passes. Compilation still accepts/lowers the whole project and emits every object; no automatic cache hit, edit invalidation, shared-data support, or warm-speed result exists. Implement independent module work and atomic publish/read-back cache validation. Stage 2 bootstrap remains above 64 MiB working set. Prove real hits and correct implementation/API invalidation, not merely standalone relink or a warm timer. |
