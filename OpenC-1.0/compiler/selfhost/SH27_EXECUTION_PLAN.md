...
| 6. Incremental objects | Isolated interface, COFF identity, module objects, native relink, and saved-file relink passed; actual cache hits not implemented | [Interface projection](https://github.com/BoQsc/OpenC-Programming-Language/blob/c0b2343/SH27_INTERFACE_FINGERPRINT_EVIDENCE.md), [stable COFF names](https://github.com/BoQsc/OpenC-Programming-Language/blob/f68c65f/SH27_STABLE_COFF_IDENTITY_EVIDENCE.md), [module objects](https://github.com/BoQsc/OpenC-Programming-Language/blob/bd0a497/SH27_MODULE_COFF_SET_EVIDENCE.md), and [native relink](https://github.com/BoQsc/OpenC-Programming-Language/blob/1561b71/SH27_NATIVE_MODULE_COFF_LINK_EVIDENCE.md) passed focused proofs. The [project-free saved-object relink](https://github.com/BoQsc/OpenC-Programming-Language/blob/3205432/SH27_SAVED_OBJECT_RELINK_EVIDENCE.md) now authenticates saved COFF bytes and reproduces the PE without a source manifest; strict Stage 3→4 self-build passes. But compilation still accepts/lowers the whole project and emits every object; no automatic cache hit, edit invalidation, shared-data support, or warm-speed result exists. The reader needs a pre-allocation file-size guard and the cache needs atomic publish/read-back validation. Stage 2 bootstrap remains above 64 MiB working set. Prove real object hits and correct implementation/API invalidation, not merely standalone relink or a warm timer. |
