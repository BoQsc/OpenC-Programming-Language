...
| 2-3. Fused semantics and lowering | Partial opt-in first-visit cut; throughput unproved | The isolated scalar-sweep fusion was correct (278/278, strict 20/20) but clean-speed flat/regressive. The later [function semantic/IR Phase B1](https://github.com/BoQsc/OpenC-Programming-Language/blob/8489962/OpenC-1.0/compiler/selfhost/SH27_FUNCTION_SEMANTIC_IR_DESIGN.md) removes both legacy expression sweeps for 7/8 large-function sources with exact PE/runtime and guarded fixed point, but the call-heavy critical source 0 and control/self-build remain legacy. Widen first-visit coverage before any guarded two-lane wall claim; no eager extra pass or duplicate generic-record arena. |
