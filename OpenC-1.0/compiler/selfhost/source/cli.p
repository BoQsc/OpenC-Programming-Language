...
void cli_print_help() {
    ...
    io.println("  openc artifact --project=PROJECT --kind=module-coff-set --output=PREFIX");
    ...
    io.println("  openc --windows-winmd-project Windows.Win32.winmd OUTPUT_DIR MANIFEST.json");
