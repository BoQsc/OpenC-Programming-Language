...
unsafe bool write_build_timings(
    ...
    d_put(output, ",\n    \"deferred_scalar\": {\n      \"sources\": ");
    d_put_usize(output, timings.deferred_scalar_sources);
    d_put(output, ",\n      \"accepted_sources\": ");
    d_put_usize(output, timings.deferred_scalar_accepted_sources);
    d_put(output, ",\n      \"fallback_sources\": ");
    d_put_usize(output, timings.deferred_scalar_fallback_sources);
    d_put(output, ",\n      \"rules_expected\": ");
    d_put_usize(output, timings.deferred_scalar_rule_expected);
    d_put(output, ",\n      \"rules_checked\": ");
    d_put_usize(output, timings.deferred_scalar_rule_checked);
    d_put(output, ",\n      \"legacy_scan_nodes_skipped\": ");
    d_put_usize(output, timings.deferred_legacy_scan_nodes_skipped);
    d_put(output, "\n    }");
